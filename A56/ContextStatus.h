...
enum TimeStatus : uint8_t {
    ...
    // Season flags (11-14) - //@@ error =based on month
   ...
   //@@ error: abandon avg temp flags by two uint8_t coded temperature
 STATUS_FREEZING,    // < 0°C
    STATUS_COLD,        // 0-10°C
    STATUS_MILD,        // 10-20°C
    STATUS_WARM,        // 20-30°C
    ...
    //@@ replace this bloating stupid simplification: Moon phase flags (28-31) - based on lunar cycle
