...
5. If approved, the **Run** code asks the appropriate **Manager** to execute. Managers update hardware via their drivers and report state back up the stack.
