 ...
 * @date 2025-12-31
 *
 * Implements heartbeat rate calculation: maps distance sensor readings to
 * blink intervals (near = fast, far = slow), applies jitter filtering, and
 * provides bootstrap/configure functions.
 */
