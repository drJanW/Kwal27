 ...
 * Defines the ContextManager namespace with TimeContext structure for time tracking,
...
bool ContextManager_post(ContextManager::WebCmd cmd, uint8_t dir = 0, uint8_t file = 0, int8_t delta = 0);
